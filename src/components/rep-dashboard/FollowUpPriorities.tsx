      ...
      {followUps.length > 0 ? (
        <div className="space-y-3">
          {followUps.map(({ submission, priority, daysSince }) => (
            <div 
              key={submission.id} 
              className="flex items-center justify-between p-3 bg-light-bg-secondary dark:bg-gray-700 rounded-lg hover:bg-light-bg-tertiary dark:hover:bg-gray-600 transition-colors"
            >
              <div className="flex-1">
                ...
                {submission.specificNeeds && (
                  <p className="text-xs text-light-text-tertiary dark:text-gray-500 mt-1 line-clamp-1">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-light-text-tertiary dark:text-gray-500">
