...
export default function SubmissionsPage() {
  ...
  const { submissions, totalCount, pageCount, isLoading, filters, pagination, setPagination, setFilters, resetFilters, refetch } = useSubmissions({});
  ...
  return (
    <DashboardLayout title="Submissions">
      <div className="mb-8">
        ...
        <SubmissionTable data={submissions} isLoading={isLoading} totalItems={totalCount} onDelete={handleDelete} />

        {pageCount > 0 && (
          <div className="mt-4 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex items-center">
              <label htmlFor="pageSize" className="mr-2 text-light-text-secondary dark:text-gray-400 text-xs sm:text-sm">
                Show:
              </label>
              <select
                id="pageSize"
